...
- [Browser Automation](https://amaiya.github.io/patchpal/features/tools/#browser-automation-14-tools) for interactive web tasks, form filling, and JavaScript-heavy sites
